...
# 5. test_set_book_genre_nonexistent_book ---> Проверяем, что нельзя установить жанр несуществующей книге.
# 6. test_get_book_genre_different_cases ---> Проверяем получение жанра для раздичных случаев.
# 7. test_get_books_with_specific_genre_found ---> Поиск книги по существующему жанру.
# 8. test_get_books_with_specific_genre_not_found ---> Поиск книги по несуществующему жанру.
# 9. test_get_books_for_children_different_genres ---> Проверка фильтрации книг по возрасту.
